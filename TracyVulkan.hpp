...
#  define TracyVkNamedZone( ctx, varname, cmdbuf, name, active ) static const tracy::SourceLocationData TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE) { name, TRACY_SOURCE_LOCATION_FUNCTION,  TRACY_SOURCE_LOCATION_FILE, (uint32_t)TRACY_SOURCE_LOCATION_LINE, 0 }; tracy::VkCtxScope varname( ctx, &TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE), cmdbuf, TRACY_CALLSTACK, active );
#  define TracyVkNamedZoneC( ctx, varname, cmdbuf, name, color, active ) static const tracy::SourceLocationData TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE) { name, TRACY_SOURCE_LOCATION_FUNCTION,  TRACY_SOURCE_LOCATION_FILE, (uint32_t)TRACY_SOURCE_LOCATION_LINE, color }; tracy::VkCtxScope varname( ctx, &TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE), cmdbuf, TRACY_CALLSTACK, active );
...
#else
#  define TracyVkNamedZone( ctx, varname, cmdbuf, name, active ) static const tracy::SourceLocationData TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE) { name, TRACY_SOURCE_LOCATION_FUNCTION,  TRACY_SOURCE_LOCATION_FILE, (uint32_t)TRACY_SOURCE_LOCATION_LINE, 0 }; tracy::VkCtxScope varname( ctx, &TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE), cmdbuf, active );
#  define TracyVkNamedZoneC( ctx, varname, cmdbuf, name, color, active ) static const tracy::SourceLocationData TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE) { name, TRACY_SOURCE_LOCATION_FUNCTION,  TRACY_SOURCE_LOCATION_FILE, (uint32_t)TRACY_SOURCE_LOCATION_LINE, color }; tracy::VkCtxScope varname( ctx, &TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE), cmdbuf, active );
...
#  define TracyVkNamedZoneS( ctx, varname, cmdbuf, name, depth, active ) static const tracy::SourceLocationData TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE) { name, TRACY_SOURCE_LOCATION_FUNCTION,  TRACY_SOURCE_LOCATION_FILE, (uint32_t)TRACY_SOURCE_LOCATION_LINE, 0 }; tracy::VkCtxScope varname( ctx, &TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE), cmdbuf, depth, active );
#  define TracyVkNamedZoneCS( ctx, varname, cmdbuf, name, color, depth, active ) static const tracy::SourceLocationData TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE) { name, TRACY_SOURCE_LOCATION_FUNCTION,  TRACY_SOURCE_LOCATION_FILE, (uint32_t)TRACY_SOURCE_LOCATION_LINE, color }; tracy::VkCtxScope varname( ctx, &TracyConcat(__tracy_gpu_source_location,TRACY_SOURCE_LOCATION_LINE), cmdbuf, depth, active );
